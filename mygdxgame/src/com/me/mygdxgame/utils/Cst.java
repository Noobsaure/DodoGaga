...
public class Cst {
	...
	public static final Point2i MAP_SIZE = new Point2i(100, 50);
	
	public static final int TILE_HW = TILE_W / 2;
	public static final int TILE_HH = TILE_H / 2;
	
	public static final int NB_CELL = 4;
	
	public static final int CELL_W = TILE_W / NB_CELL;
	public static final int CELL_H = TILE_H / NB_CELL;
