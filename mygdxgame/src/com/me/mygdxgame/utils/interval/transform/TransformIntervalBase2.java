...
public abstract class TransformIntervalBase2 extends Interval{
	...
	public TransformIntervalBase2(IntervalTransformable transformable, float duration, Point2i end, String xInterpolation, String yInterpolation, Point2f start) {
		super(transformable, duration);
		this.end = GameMap.tileToIsof(end.x,end.y);
		if(start != null){
