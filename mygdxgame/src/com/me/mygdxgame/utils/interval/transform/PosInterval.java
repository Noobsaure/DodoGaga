...
public class PosInterval extends TransformIntervalBase2{
	...
	public PosInterval(IntervalTransformable transformable, float duration, Point2i end, String xInterpolation, String yInterpolation) {		
		this(transformable, duration, end, xInterpolation, yInterpolation, null);
	}
	...
	public PosInterval(IntervalTransformable transformable, float duration, Point2i end, String xInterpolation, String yInterpolation, Point2f start) {
		super(transformable, duration, end, xInterpolation, yInterpolation, start);
		transformType = Interval.TransformType.POS;
	}
